    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
            ...
            <div id="basicform" class="subcontent">
                ...
                <form class="stdform" action="{{ url('admin/article') }}" method="post">
                    {{csrf_field()}}
                    ...
                    <p>
                        <label>文章标题</label>
                        <span class="field"><input type="text" name="art_title" class="smallinput" /></span>
                    </p>

                    <p>
                        <label>作者</label>
                        <span class="field"><input type="text" name="art_editor" class="mediuminput" /></span>
                    </p>

                    <p>
                        <label>缩略图</label>
                            <span class="field">
                                <input type="text" name="art_thumb" class="smallinput"/>
...
//                                    alert(data);
                    ...
                    <p>
                        <label></label>
                        <span class="field"><img src="" alt="" id="art_thumb_img" style="max-width: 350px; max-height:100px;"/></span>
                    </p><br />

                    <p>
                        <label>关键词</label>
                            <span class="field">
                            	<input name="art_tag" id="tags" class="longinput" value="" />
                            </span>
                    </p>

                    <p>
                        <label>描述</label>
                        <span class="field"><textarea cols="80" rows="5" class="longinput" name="art_description"></textarea></span>
                    </p>
                    ...
                    <p>
                        ...
                        <script name="art_content" id="editor" type="text/plain" style="width:770px;height:500px;"></script>
                        <script type="text/javascript">
